...
-- 3. Index pour la recherche par programme (page Programme, sp_GetLiensProgramme)
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = N'IX_LINE_VIS_HEA_EXE_PGM_NME' AND object_id = OBJECT_ID(N'dbo.LINE_VIS_HEA'))
    CREATE INDEX IX_LINE_VIS_HEA_EXE_PGM_NME ON dbo.LINE_VIS_HEA (EXE_PGM_NME);
GO
